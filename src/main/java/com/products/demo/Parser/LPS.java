...
public class LPS {
    ...
    public static class LPSBuilder {
        ...
        public LPSBuilder withTimestamp(String timestamp) { lps.timestamp = timestamp; return this; }
        public LPSBuilder withEvent(String event) { lps.event = event; return this; }
        public LPSBuilder withUser(UserInfo user) { lps.user = user; return this; }
        public LPSBuilder withAction(ActionInfo action) { lps.action = action; return this; }
        public LPS build() { return lps; }
        ...
        public static UserInfo parseUser(JsonNode node) {
            ...
            if (!node.path("age").isNull()) user.age = node.path("age").asInt();
            return user;
        }
